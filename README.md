...
<p align="center">
  ...
  <a href="./pyproject.toml"><img alt="Codebase Version" src="https://img.shields.io/badge/codebase-v4.5.1-1f883d?style=flat-square"></a>
...
| CI/CD | `publish-ghcr.yml` (container), `publish-tauri-macos.yml` (desktop assets + OTA), `update-homebrew-tap.yml` (formula) |
