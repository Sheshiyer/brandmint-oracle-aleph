...
PROMPT_3A = """HeyZack capsule collection product lineup.
...
PROMPT_3B = """HeyZack hero product shot. a slim wall-mounted smart control panel with matte-black housing, tempered-glass face, crisp blue-and-pink interface accents, and live widgets for climate, access, security, and energy savings.
...
PROMPT_3C = """HeyZack product product shot. Premium branded container with clean label design
...
PROMPT_APP_SCREENSHOT = """HeyZack app screenshot inside a modern phone frame. Show a polished,
believable control dashboard for lighting, climate, access, cameras, and energy,
with a premium blue-and-pink UI language. Include live savings metrics,
scene controls, and device cards that feel production-ready for both homes and
commercial spaces. Avoid fantasy HUDs or generic template UI.
"""
...
def main():
    ...
    print("\n--- APP-SCREENSHOT: App Store Screenshot (Nano Banana Pro) ---")
    gen_nano_banana("APP-SCREENSHOT", "app_screenshot", PROMPT_APP_SCREENSHOT, "9:16", image_urls)
