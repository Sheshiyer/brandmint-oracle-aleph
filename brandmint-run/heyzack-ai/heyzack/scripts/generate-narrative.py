...
PROMPT_7A = """HeyZack editorial contact sheet. 9-panel lifestyle usage grid across different moments — 3x3 grid, 9 panels,
...
PROMPT_EMAIL_HERO = """HeyZack email hero image. A warm, premium scene with the HeyZack Smart Control Panel,
a mobile dashboard glimpse, and believable architectural context. Emphasize comfort,
control, and savings rather than spectacle. Keep the layout clean for marketing
email use, with brand mark visibility and polished real-world lighting.
"""
...
def main():
    ...
    print("\n--- EMAIL-HERO: Email Header Hero ---")
    gen_nano_banana("EMAIL-HERO", "email_hero", PROMPT_EMAIL_HERO, "16:9", image_urls)
