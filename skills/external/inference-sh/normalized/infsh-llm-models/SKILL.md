...
description: 'Access Claude, Gemini, Kimi, GLM and 100+ LLMs via inference.sh CLI
  ...
  fallback and cost optimization. Use for: AI assistants, code generation, reasoning,
  agents, chat, content generation. Triggers: claude api, openrouter, llm api, claude
  sonnet, claude opus, gemini api, kimi, language model, gpt alternative, anthropic
  api, ai model api, llm access, chat api, claude alternative, openai alternative'
allowed-tools:
- Bash(infsh *)
source_repo: https://github.com/inference-sh/skills.git
source_commit: ab546d072f1e41adac2fa65ca3743c21c041e399
source_skill: llm-models
---
