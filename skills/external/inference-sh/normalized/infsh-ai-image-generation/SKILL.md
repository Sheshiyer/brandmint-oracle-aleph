---
name: infsh-ai-image-generation
description: 'Generate AI images with FLUX, Gemini, Grok, Seedream, Reve and 50+ models
  ...
  inpainting, LoRA, image editing, upscaling, text rendering. Use for: AI art, product
  mockups, concept art, social media graphics, marketing visuals, illustrations. Triggers:
  flux, image generation, ai image, text to image, stable diffusion, generate image,
  ai art, midjourney alternative, dall-e alternative, text2img, t2i, image generator,
  ai picture, create image with ai, generative ai, ai illustration, grok image, gemini
  image'
allowed-tools:
- Bash(infsh *)
source_repo: https://github.com/inference-sh/skills.git
source_commit: ab546d072f1e41adac2fa65ca3743c21c041e399
source_skill: ai-image-generation
---
